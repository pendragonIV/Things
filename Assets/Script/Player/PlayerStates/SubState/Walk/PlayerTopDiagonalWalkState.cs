...
public class PlayerTopDiagonalWalkState : PlayerBaseState
{
    public PlayerTopDiagonalWalkState(Player player, StateMachine stateMachine, PlayerProps playerProps, string animationName) : base(player, stateMachine, playerProps, animationName)
    {
    }
